...
def filter_items(queryset, name_contains=None, project=None, item_type=None, item_status=None, item_location=None):
    ...
    Arguments:
        ...
        item_location (ID): An ItemLocation ID to filter the item_location field by.
    ...
    if item_location:
        queryset = queryset.filter(item_location=item_location)
    return queryset
