...
ALLOWED_HOSTS = [
    'backend', # Docker container name is used within the Docker network
    'localhost', # Host localhost is used to/from outside the Docker network
]
...
# GraphQL using Graphene and GraphQL JTW
