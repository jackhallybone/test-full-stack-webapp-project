...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'project_id', name='_item_location_uc_name_project')
    )
    op.create_index(op.f('ix_item_location_id'), 'item_location', ['id'], unique=False)
    op.create_index(op.f('ix_item_location_project_id'), 'item_location', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_item_status_project_id'), 'item_status', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_item_type_project_id'), 'item_type', ['project_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['item_location_id'], ['item_location.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['item_status_id'], ['item_status.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['item_type_id'], ['item_type.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['project_id'], ['project.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_item_id'), 'item', ['id'], unique=False)
    op.create_index(op.f('ix_item_item_location_id'), 'item', ['item_location_id'], unique=False)
    op.create_index(op.f('ix_item_item_status_id'), 'item', ['item_status_id'], unique=False)
